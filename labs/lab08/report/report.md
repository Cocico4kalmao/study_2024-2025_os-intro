...
![Фильтрация поиска](image/4.png){#fig:005 width=70%}

Записываю все логи в файл. (рис. -@fig:006)

![Запись местоположений лог файлов](image/5.png){#fig:006 width=70%}

Открываю в фоне процесс и завершаю его. (рис. -@fig:007)

![Завершение процессов через терминал](image/6.png){#fig:007 width=70%}

Вывожу все директории домашнего каталога. (рис. -@fig:008)

![Вывод всех директорий](image/7.png){#fig:008 width=70%}
